...
| File | When to read |
|------|--------------|
| [`./principles.md`](./principles.md) | Cross-cutting principles for any agent-facing markdown file — read before authoring or editing one |
| [`./progressive-disclosure.md`](./progressive-disclosure.md) | Deciding how a topic is split across files and how its hubs route — read when shaping or restructuring a multi-file topic |
| [`./organization.md`](./organization.md) | Deciding where a fact or file belongs and whether a new document is warranted — read when placing, naming, or admitting an agent-facing file, or auditing a directory's contents against its purpose |
