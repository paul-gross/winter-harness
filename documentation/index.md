...
Conventions for **public / adopter-facing documentation** — the published docs site (`winter-docs`) and every repo's `README.md`: README form, the no-undocumented-feature currency invariant, the canonical-source-versus-rendered-view rule, and the consumable-extension-versus-example catalog classification. The audience is a human evaluating or adopting winter, not an agent traversing context.
