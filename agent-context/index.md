...
Conventions for authoring and validating **agent context** — the material an agent loads or traverses to do work: agents, skills, reusable methodology, extension `index.md` files, routing tables, cross-context path references, and the lints that mechanically enforce them. Specific to winter.
